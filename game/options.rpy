...
define config.name = _("運命のささやき: 私のそばに降り立つ星空ニャン")
...
define build.name = "WhispersOfDestiny"
...
define config.save_directory = "WhispersOfDestiny-1701251951"
